...
plot(ds3$date, log(ds3$hospt_admit), type='l', bty='l', main='Log Hospitalizations')
abline(v=as.Date(c('2020-03-17','2020-03-24','2020-03-31','2020-04-07','2020-04-14','2020-04-21','2020-04-28')), lty=2, col='gray')
...
plot(ds3$date, log(ds3$prop.pos/(1-ds3$prop.pos)), main='Logit(Proportion of human tests positive)', xlab='Date', ylab='Proportion positive', bty='l')
abline(v=as.Date(c('2020-03-17','2020-03-24','2020-03-31','2020-04-07','2020-04-14','2020-04-21','2020-04-28')), lty=2, col='gray')



plot(ds3$date, (ds3$new.cases), main='New cases', col=as.factor(ds3$target), xlab='Date', ylab='Log Concentration')
abline(v=as.Date(c('2020-03-17','2020-03-24','2020-03-31','2020-04-07','2020-04-14','2020-04-21','2020-04-28')), lty=2, col='gray')


plot(ds3$date, log(ds3$new.cases), main='log-New cases', col=as.factor(ds3$target), xlab='Date', ylab='Log Concentration')
abline(v=as.Date(c('2020-03-17','2020-03-24','2020-03-31','2020-04-07','2020-04-14','2020-04-21','2020-04-28')), lty=2, col='gray')
...
yrange <- range(beta.hospt)
plot(0:7, beta.hospt[,"post_means"], ylim=yrange, bty='l', ylab='Beta', xlab='Lag (days)' , pch=16)
arrows(x0=0:7, y0=beta.hospt[,"lower"], y1=beta.hospt[,"upper"], length=0)
abline(h=0)
```
...
```{r}
#Extract the betas
beta.hospt <- lapply(mods.cases.dx,'[[','beta1')
beta.hospt <- do.call('rbind.data.frame',beta.hospt)
...
yrange <- range(beta.rep)
plot(0:7, beta.rep[,"post_means"], ylim=yrange, bty='l', ylab='Beta', xlab='Lag (days)' , pch=16)
arrows(x0=0:7, y0=beta.rep[,"lower"], y1=beta.rep[,"upper"], length=0)
abline(h=0)
```
```{r}
...
## Instead, use distributed lags framework
...
Distributed lags for the association between viral RNA in sewage and COVID hospitalizations. This shows that lags of 1-4 days are associated with hospitalization. +/-90% Credible Intervals.
